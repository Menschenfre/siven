def call() {
  ...
  stage ('pruebasUnitarias') {
    if ("${soloStage}" == 'pruebasUnitarias') {
      def pruebasUnitarias = fileLoader.fromGit('mobile/stages/pruebasUnitarias', 'git@bitbucket.org:bancocreditoeinversiones/pipelines-jenkins.git', 'master', null, '')
  ...
  stage ('pruebasCobertura') {
    if ("${soloStage}" == 'pruebasCobertura') {
      def pruebasCobertura = fileLoader.fromGit('mobile/stages/pruebasCobertura', 'git@bitbucket.org:bancocreditoeinversiones/pipelines-jenkins.git', 'master', null, '')
  ...
  stage ('pruebasFuncionales') {
    if ("${soloStage}" == 'pruebasFuncionales') {
      ...
      def pruebasFuncionales = fileLoader.fromGit('mobile/stages/pruebasFuncionales', 'git@bitbucket.org:bancocreditoeinversiones/pipelines-jenkins.git', 'master', null, '')
