def call() {
  ...
  def common, buildCodigo, checkingQA, login, crearImagenDocker, template, deployKubernetes, docker, nexus, apiConnect, deployIngress
  fileLoader.withGit('git@bitbucket.org:bancocreditoeinversiones/pipelines-jenkins.git', 'master', null, '') {
    ...
    buildCodigo = fileLoader.load('servicios-integracion-ejb/stages/buildCodigo');
