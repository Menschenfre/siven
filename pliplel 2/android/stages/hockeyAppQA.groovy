def call() {
	...
	env.APK_PATH = "@app/build/outputs/apk/qa/app-qa.apk"
	env.URL_ANDROID_UPLOAD = "-X POST https://rink.hockeyapp.net/api/2/apps/${ANDROID_APP_ID_QA}/app_versions/upload"
